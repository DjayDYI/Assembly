...
public class Generator {
    ...
    String LT(String x, String y)
    {
        return res(x, y)+  " LT ";
    }
    String GT(String x, String y)
    {
        return res(x, y)+  " GT ";
    }
    String LEQ(String x, String y)
    {
        return res(x, y)+  " LEQ ";
    }
    String GEQ(String x, String y)
    {
        return res(x, y)+  " GEQ ";
    }
    String NOT(String x)
    ...
    String NEQ(String x, String y)
    {
        return res(x, y)+  " NEQ ";
    }
    String EQ(String x, String y)
    {
        return res(x, y)+  " EQ ";
    }
    ...
    Generator(String str)
    {
        ...
        for(int i = 0; i<s.length;i++)
        {
            switch (s[i]) {
                ...
                case "GT" -> res.append(GT(s[++i], s[++i]));
                case "LT" -> res.append(LT(s[++i], s[++i]));
                case "GEQ" -> res.append(GEQ(s[++i], s[++i]));
                case "LEQ" -> res.append(LEQ(s[++i], s[++i]));
                case "EQ" -> res.append(EQ(s[++i], s[++i]));
                case "NEQ" -> res.append(NEQ(s[++i], s[++i]));
